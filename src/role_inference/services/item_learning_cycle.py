...
from .item_catalog_classifier import (
    ItemCatalogClassifier,
)
from .item_observation_collector import (
...
class ItemLearningCycle:
    ...
    1. classifica itens pelos metadados + observações atuais;
    2. infere papéis iniciais das unidades;
    3. coleta novas observações;
    4. persiste as observações;
    5. recalcula as classificações.

    O ciclo não altera automaticamente pesos ou regras.
    """
    ...
    def run(
        ...
        *,
        ...
        existing = (
            self.observation_repository.load_all()
        )
        ...
        updated_observations = (
            ItemObservationCollector.collect(
                matches=matches,
        ...
        self.observation_repository.save_all(
            updated_observations
        )
