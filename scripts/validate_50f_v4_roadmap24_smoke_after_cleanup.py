...
for relative in TESTS:
    ...
    if not path.exists():
        checks.append((f"Teste ausente: {relative}", False, "arquivo não encontrado"))
        continue
...
print("=" * 114)
print("#50F-V4 / ROADMAP 24.3B - SMOKE TEST PÓS-HOTFIX DE CONSOLE")
print("=" * 114)
...
if passed != len(checks):
    print("#50F-V4 ROADMAP 24.3B: REVISAR — MANTENHA O ARCHIVE")
    raise SystemExit(1)

print("#50F-V4 ROADMAP 24.3B: SMOKE TEST VALIDADO")
print("ARQUIVAMENTO DE LEGADO VALIDADO")
