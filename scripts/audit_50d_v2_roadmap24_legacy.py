...
# Referências destes scripts são administrativas: eles próprios enumeram os
# candidatos de limpeza e não constituem dependência funcional do produto.
ADMIN_SCRIPTS = {
...
print("=" * 112)
print("#50D-V2 / ROADMAP 24.3B - AUDITORIA DE DEPENDÊNCIAS REAIS")
print("=" * 112)
...
if blocked:
    print("#50D-V2 ROADMAP 24.3B: REVISAR DEPENDÊNCIAS REAIS")
    raise SystemExit(1)

print("#50D-V2 ROADMAP 24.3B: TODOS OS CANDIDATOS LIBERADOS PARA ARQUIVO")
