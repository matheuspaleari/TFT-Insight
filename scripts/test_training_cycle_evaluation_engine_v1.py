...
def main() -> None:
    ...
    real = evaluate(real_before, real_after)
    ...
    checks = [
        ...
        (
            "Ciclo real não recebe confiança HIGH",
    ...
    print("=" * 82)
    print("TFT INSIGHT - TRAINING CYCLE EVALUATION ENGINE V1")
    print("=" * 82)
    ...
    print(f"Confiança  : {real.confidence} ({real.confidence_score:.2f}%)")
    print(
        "Sinais     : "
    ...
    if passed == len(checks):
        print("TRAINING CYCLE EVALUATION ENGINE V1: VALIDADO")
        raise SystemExit(0)

    print("TRAINING CYCLE EVALUATION ENGINE V1: AJUSTE NECESSÁRIO")
    raise SystemExit(1)
