...
Transforma dados de partidas em contexto estratégico, prioridades de aprendizado e ações objetivas para o próximo lobby.
...
Pressão por carries, unidades e traits que podem mudar a decisão de jogo.
...
### 🧭 Coach orientado à decisão

As inteligências alimentam uma prioridade prática para a próxima partida.
...
## Do histórico à próxima decisão
...
**telemetria → decisão → comunicação**

Os dados observados sustentam a análise; os engines determinísticos escolhem prioridades; a camada de narrativa apresenta o resultado de forma mais natural.
...
A interface foi desenhada para apresentar primeiro o contexto e a prioridade de decisão, mantendo os detalhes disponíveis para aprofundamento quando necessário.
...
As próximas etapas estão concentradas em documentação, consolidação da arquitetura e preparação do repositório como projeto de portfólio.
