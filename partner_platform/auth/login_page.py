...
def render_auth_page() -> None:
    ...
    with tab_login:
        with st.form("tft_auth_login", clear_on_submit=False):
            email = st.text_input(
                "E-mail",
        ...
        st.caption("Login com Google será adicionado na etapa 26.1D.")

    with tab_register:
        with st.form("tft_auth_register", clear_on_submit=False):
            ...
            password = st.text_input(
                ...
                help="Mínimo de 8 caracteres, com pelo menos uma letra e um número.",
            )
